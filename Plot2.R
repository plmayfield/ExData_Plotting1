...
Plot2 <- function()
{
  ...
  png (file = "plot2.png", bg="white", width = 480, height = 480, units = "px") ##open file
  plot(x$FullDate,x$Global_active_power,type="l", xlab = "", ylab="Global Active Power (kilowatts")
  dev.off() ##close file
}
